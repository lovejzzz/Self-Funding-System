...
function assertStaticContracts(){
  ...
  for(const marker of ['LAB_SYSTEMS','initSystemsLab','initSystemsCatalog','data-system-card','initCompare','compare-room-link','data-compare-viewport'])if(!js.includes(marker))failures.push(`Systems exhibition contract missing: ${marker}`);
